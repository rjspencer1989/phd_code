...
class TestProcessRollback(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.hist1 = self.add_history_item(self.title, self.description, res1['id'], res1['rev'], dt.isoformat())
        ...
        self.hist2 = self.add_history_item(self.title, self.description, res2['id'], res2['rev'], dt.isoformat())
        ...
        self.hist3 = self.add_history_item(self.title, self.description, res3['id'], res3['rev'], dt.isoformat())
        ...
        self.hist4 = self.add_history_item(self.title, self.description, res4['id'], res4['rev'], dt.isoformat())
