...
class TestNotificationRegistrationClient(unittest.TestCase):
    ...
    def test_registration(self):
        ...
        notification_registration_client.registration(self.ret_doc, os.environ['APP_ENGINE_ROUTER_ID'])
    ...
    def test_edit(self):
        ...
        notification_registration_client.edit(v2, os.environ['APP_ENGINE_ROUTER_ID'])
        added_doc = self.db.get(self.the_id)
        self.assertIn('suid', added_doc)
    ...
    def test_delete(self):
        ...
        notification_registration_client.registration(self.ret_doc, os.environ['APP_ENGINE_ROUTER_ID'])
        v2 = self.db.get(self.the_id)
        notification_registration_client.delete(v2, os.environ['APP_ENGINE_ROUTER_ID'])
        added_doc = self.db.get(self.the_id)
