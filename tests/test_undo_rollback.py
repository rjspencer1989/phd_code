...
class TestUndoRollback(unittest.TestCase):
    ...
    def setUp(self):
        ...
        doc_arr = [{'doc_id': rd['_id'], 'doc_rev': rd['_rev'], 'doc_collection': 'request_revert', 'action': 'edit'}]
        self.rd_hist = add_history.add_history_item("unrev", "unrev", doc_arr, ts=dt.isoformat())
    ...
    def test_get_reverted_events(self):
        ...
        doc_arr = [{'doc_id': res5['id'], 'doc_rev': res5['rev'], 'doc_collection': 'notifications', 'action': 'delete'}]
