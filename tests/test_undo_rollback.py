...
class TestUndoRollback(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.hist1 = add_history_item(self.title, self.description, res1['id'], res1['rev'], 'wifi', 'edit', True, ts=dt.isoformat())
        ...
        self.hist2 = add_history_item(self.title, self.description, res2['id'], res2['rev'], 'wifi', 'edit', True, ts=dt.isoformat())
        ...
        self.hist3 = add_history_item(self.title, self.description, res3['id'], res3['rev'], 'wifi', 'edit', True, ts=dt.isoformat())
