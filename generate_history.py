...
aspire = devices.Device("d0:27:88:80:d9:ef", "10.2.0.1", "aspire", "", "", "add", "", "pending", "", "eth1")
res = db.save_doc(aspire.get_doc(), force_update=True)
print res

mrldesx2 = devices.Device("a0:f4:50:f3:48:50", "10.2.0.5", "android-aa474646cd34eeaa", "", "", "add", "", "pending", "", "wlan0")
res = db.save_doc(mrldesx2.get_doc(), force_update=True)
print res

rjsxperia1 = devices.Device("a0:e4:53:55:00:cc", "10.2.0.9", "android-5f251018c8685b52", "", "", "add", "", "pending", "", "wlan0")
res = db.save_doc(rjsxperia1.get_doc(), force_update=True)
print res

mrltablet6 = devices.Device("e0:b9:a5:8c:45:cd", "10.2.0.13", "android_8a0b6f3a084dc84a", "", "", "add", "", "pending", "", "wlan0")
res = db.save_doc(mrltablet6.get_doc(), force_update=True)
print res

callison = devices.Device("00:13:77:e1:d2:41", "10.2.0.17", "CALLISON", "", "", "add", "", "pending", "", "eth2")
