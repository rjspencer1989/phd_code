...
add_history.add_history_item("Device Permitted", "Device d0:27:88:80:d9:ef (aspire) was permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device permitted", "callison was permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Permitted", "mrldesx2 is permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Permitted", "iphone is permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Permitted", "Camera was permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Permitted", "mrltablet6 was permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Denied", "bad ipod was denied from accessing your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
...
add_history.add_history_item("Device Permitted", "rjsxperia1 was permitted to access your network", res["id"], res["rev"], 'devices', undoable=False, ts=dt.isoformat())
